-- ============================================
-- ADDITIONAL TABLES FOR TASKS, PRE-APPROVALS, PIPELINE
...
CREATE TABLE IF NOT EXISTS pipeline (
    ...
    loan_amount DECIMAL(15, 2) NOT NULL,
    loan_type VARCHAR(100),
    stage VARCHAR(100) NOT NULL, -- e.g., 'Clear to Close', 'Underwriting', 'Processing', 'Application'
    target_close_date DATE,
    assigned_lo_id INT,
    assigned_lo_name VARCHAR(255),
    investor VARCHAR(255),
    investor_id INT,
    status VARCHAR(100) DEFAULT 'On Track', -- e.g., 'On Track', 'Conditions Out', 'Delayed'
    notes TEXT,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    FOREIGN KEY (assigned_lo_id) REFERENCES users(id) ON DELETE SET NULL,
...
-- ========================================
-- API KEYS TABLE (for Zapier/webhook authentication)
-- ========================================
CREATE TABLE IF NOT EXISTS api_keys (
    ...
    user_id INT NOT NULL, -- User who owns this API key (data will be associated with this user)
...
-- ========================================
-- WEBHOOK LOGS TABLE (for tracking webhook calls)
-- ========================================
