...
const CONTROLLED_REASON_CODE_DEFINITIONS = Object.freeze({
  ...
  ASSET_NOT_FOUND: reasonCodeDefinition(422, 'webinar.validation_rejected'),
  ASSET_ORIGIN_NOT_CONFIGURED: reasonCodeDefinition(503, 'webinar.validation_rejected'),
  ASSET_REFERENCE_INVALID: reasonCodeDefinition(400, 'webinar.validation_rejected'),
  ...
  ASSET_TOKEN_FORMAT: reasonCodeDefinition(422, 'webinar.validation_rejected'),
