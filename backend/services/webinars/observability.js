...
const REASON_CODES = new Set([
  ...
  'CONTENT_LIMIT_EXCEEDED', 'UNSUPPORTED_MEDIA_TYPE',
  'WEBINAR_NOT_FOUND', 'SLIDE_NOT_FOUND', 'NOTE_NOT_FOUND', 'REVISION_NOT_FOUND',
  ...
  'SHORTCUT_BINDING_INVALID', 'SHORTCUT_BINDING_RESERVED', 'SHORTCUTS_INVALID',
  'SHORTCUT_ACTION_UNKNOWN', 'SHORTCUT_BINDING_DUPLICATE', 'PREFERENCES_INVALID',
  'PREFERENCE_KEY_UNSAFE', 'PREFERENCE_VALUE_INVALID',
  'PUBLIC_DELIVERY_FAILURE', 'PUBLIC_RUNTIME_ERROR', 'ASSET_SCAN_PENDING', 'ASSET_SCAN_REJECTED',
  'ASSET_INSPECTION_REJECTED', 'ASSET_AVAILABLE', 'ASSET_SCANNER_FAILURE',
]);
